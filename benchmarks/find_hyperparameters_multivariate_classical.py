...
output_path = cwd + "/hyperparameters/hyperparameters_classical_" + dataname + ".json"
...
parameter_candidates["KalmanForecaster"] = {"dim_x": time_delays}
for model_name in ["AutoARIMA", "FFT", "TBATS", "NaiveDrift", "NaiveMean", "NaiveSeasonal", "Prophet"]:
