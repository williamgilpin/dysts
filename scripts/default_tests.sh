...
python rc_chaos/Methods/Models/esn/esn_rc_dyst_copy.py --cell "ESN" --reservoir_size 1000 --sparsity 0.01 --radius 0.6 --sigma_input 1 --dynamics_fit_ratio 0.2857 --regularization 0.0 --scaler_tt Standard --solver auto
